...
آشنایی با \lr{MariaDB / MySQL} و \lr{MongoDB}
\begin{itemize}
\item تسلط به زبان \lr{SQL}
\item آشنایی با کوئری های دیتابیس های غیر رابطه ای
\item آشنایی با مفاهیم \lr{relationship} و استفاده از \lr{ORM}
\end{itemize}
\subsubsection{\lr{Automation}}
معمولا از \lr{Makefile} و اسکریپت های \lr{Bash} استفاده میکنم
\subsubsection{\lr{Devops}}
آشنایی مقدماتی با مباحث \lr{Devops} و \lr{GitLab CLI}
...
\subsection{صنعتی شریف}
\subsubsection{\kvdash{B.Sc.}{(2018 - 2022)}}
ریاضیات و کاربردها
[{\footnotesize \lr{MATHEMATICS AND APPLICATIONS}}] -
گرایش ریاضی نظری (محض)
\subsection{مرتبط}
\subsubsection{\textbf{شبکه}}
آشنایی با پروتکل های \lr{TCP / UDP} و برخی پروتکل های لایه های پایین تر و پروتکل های وب و ایمیل
\subsubsection{\textbf{ساختمان داده}}
بیشتر مباحث کتاب \lr{CLRS} شامل ساختمان های داده و الگوریتم ها و آنالیز مقدماتی الگوریتم ها
\subsubsection{\textbf{مدارمنطقی}}
آشنایی با نمایش اعداد و جبر بول و \lr{latch} ها
\subsubsection{\textbf{آمار / تحلیل رگرسیون}}
تست های آماری - رگرسون خطی و غیر خطی و کار زبان \lr{R}
\section{سوابق}
