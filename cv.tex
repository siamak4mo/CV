...
آشنایی با \lr{SQL} و \lr{NoSQL}
\begin{itemize}
\item تسلط به زبان \lr{SQL} \lr{(MariaDB / MySQL)} و آشنایی با \lr{MQL} \lr{(MongoDB)}
...
آشنایی با نمایش اعداد - جبر بول - \lr{latch}
